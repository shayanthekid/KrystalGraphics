...
<!-- Additional Content -->
 <div class="col-span-2 md:col-span-1  px-4 py-16 md:w-full">
        <h2 class="text-2xl font-semibold text-left mb-2 py-4">Bags</h2>
        <p class="text-gray-700 leading-relaxed mb-4 py-4">
            
 Printing packaging bags is an essential aspect of effective branding and product presentation. Our printing services offer top-quality, customizable packaging solutions that leave a lasting impression. We employ advanced printing techniques and a variety of materials to create packaging bags that align seamlessly with your brand's identity and values. Whether for retail, e-commerce, or promotional needs, our expert team ensures that your packaging bags not only protect your products but also serve as powerful marketing tools. Elevate your brand's visibility and customer experience with our precision printing, transforming every purchase into a memorable and visually compelling statement of your brand's excellence.
...
<script>
    function carousel() {
        return {
           ...
           '{{ asset('images/services/embroidery/bag2.jpg') }}',
