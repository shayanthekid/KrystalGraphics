...
@section('content')
 <div class="container grid grid-cols-1 md:grid-cols-2">
    ...
    <!-- first column-->
<div x-data="carousel()" class="bg-[#D9D9D9] relative">
    <!-- Left Arrow -->
    ...
    <!-- Right Arrow -->
    <div @click="nextImage" class="absolute right-4 top-1/2 transform -translate-y-1/2 bg-black rounded-full w-8 h-8 flex items-center justify-center cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="white" class="w-4 h-4">
