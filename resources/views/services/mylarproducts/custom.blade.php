...
<script>
    ...
    function carousel() {
        return {
               images: [
           '{{ asset('images/services/mylar/custom/custom1-min.png') }}',
           '{{ asset('images/services/mylar/custom/custom2-min.png') }}',
           '{{ asset('images/services/mylar/custom/custom3-min.png') }}',
