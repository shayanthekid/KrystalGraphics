    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                {{-- Title --}}
                <h2 class="text-2xl font-bold mb-2 hero-text" style="opacity: 0">Standard Size</h2>
                {{-- Description --}}
                <p class="text-gray-600 text-sm mt-2 hero-para" style="opacity: 0">
             
Elevate your product packaging with our premium printing services for standard-sized Mylar bags. We specialize in transforming these versatile bags into captivating showcases for your brand or merchandise. Our precise printing technology ensures that your labels, logos, or custom designs are flawlessly imprinted on these high-quality Mylar surfaces, offering not only durability but also a professional and visually appealing presentation
                    </p>
