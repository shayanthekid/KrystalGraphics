...
<!-- Additional Content -->
 <div class="col-span-2 md:col-span-1  px-4 py-16 md:w-full">
        <h2 class="text-2xl font-semibold text-left mb-2 py-4">Beanies</h2>
...
<script>
    function carousel() {
        return {
             images: [
           '{{ asset('images/services/embroidery/beanies/beanie.png') }}',
           '{{ asset('images/services/embroidery/beanies/beanie2.png') }}',
