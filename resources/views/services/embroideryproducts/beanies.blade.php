    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                {{-- Title --}}
                <h2 class="text-2xl font-bold mb-2 hero-text" style="opacity: 0">Beanies</h2>
                {{-- Description --}}
                <p class="text-gray-600 text-sm mt-2 hero-para" style="opacity: 0">
             
Embroidery on beanies adds warmth and character to your headwear. Using premium threads and precise stitching, we create intricate and enduring designs that elevate your beanies. Whether for team merchandise, promotional giveaways, or personal fashion statements, embroidery brings a unique and professional touch. Our embroidery services offer a diverse range of thread colors and customization options, ensuring your beanies become cozy and stylish canvases for showcasing your brand or individuality with enduring quality and charm.
...
<script>
    ...
    function carousel() {
        return {
            images: [
          '{{ asset('images/services/embroidery/beanies/bean1.png') }}',
           '{{ asset('images/services/embroidery/beanies/bean3.png') }}',
           '{{ asset('images/services/embroidery/beanies/bean4.png') }}',
           '{{ asset('images/services/embroidery/beanies/bean5.png') }}',
