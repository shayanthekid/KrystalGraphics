    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                {{-- Title --}}
                <h2 class="text-2xl font-bold mb-2 hero-text" style="opacity: 0">Polo T-shirts</h2>
                {{-- Description --}}
                <p class="text-gray-600 text-sm mt-2 hero-para" style="opacity: 0">
             
Embroidery on polo T-shirts brings a touch of elegance and professionalism to your apparel. Using premium threads and precision stitching, our embroidery service creates intricate and long-lasting designs that enhance the style of your polo shirts. Whether it's for corporate uniforms, promotional merchandise, or personal fashion, embroidery offers a wide spectrum of thread colors and customization options, ensuring your polo T-shirts become sophisticated canvases for showcasing your logo or individuality with enduring quality and sophistication. Elevate your polo shirt game with embroidered designs that leave a lasting impression.                    </p>
...
<script>
    ...
    function carousel() {
        return {
           images: [
      '{{ asset('images/services/embroidery/polo/polo.png') }}',
           '{{ asset('images/services/embroidery/polo/polo2.jpg') }}',
           '{{ asset('images/services/embroidery/polo/polo3.jpg') }}',
