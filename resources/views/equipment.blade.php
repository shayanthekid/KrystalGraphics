    ...
    <div class="container mx-auto px-4 grid grid-cols-1 gap-4 md:grid-cols-2">
        <div class="container mx-auto flex justify-center lg:justify-start items-center h-full">
            <div class="text-center lg:text-left text-black">
                <h1 class="text-4xl font-semibold font-montserrat lg:text-6xl lg:py-10">Precision on Every print</h1>
...
<button @click="activateTab(index)" 
    ...
    <div class="flex space-x-4 lg:space-x-20 overflow-x-scroll ">
        <div class="flex">
    ...
    <div class="absolute inset-y-0 right-0 flex items-center ">
        <button @click="next()" class="px-4 py-2 bg-gray-900 text-white hover:bg-gray-700  transform -translate-y-1/2 bg-black rounded-full w-8 h-8 flex items-center justify-center cursor-pointer z-5">
            ...
            <div x-show="activeTab === 1" class="mt-4">
                ...
                <p>This is the content for Digital Printing.</p>
            </div>
