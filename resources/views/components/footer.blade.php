...
<footer class="bg-black text-white py-4 mt-28">
    <div class="container mx-auto grid grid-cols-10 grid-rows-2 gap-x-8">
        <!-- Row 1, Column 1: Home -->
        ...
        <!-- Row 1, Columns 3 to 9: Gap Between -->
        <div class="col-span-1">
<ul class="list-none pl-0">
               <li><a href="{{ route('embroidery') }}" class="hover:text-gray-500">Embroidery</a></li>     </ul>
        </div>
           <div class="col-span-1">
<ul class="list-none pl-0">
        <li><a href="{{ route('mylar') }}" class="hover:text-gray-500">Mylar Bags</a></li>
...
<ul class="list-none pl-0">
    <li><a href="https://www.promoplace.com/33620/" class="hover:text-gray-500">Promotion Items</a></li>
        ...
        <!-- Row 2, Column 1: Silk Screen Printing -->
        <div class="row-start-2 col-span-1 gap-24">
        ...
        <!-- Row 2, Columns 2 to 9: Gap Between -->
        <div class="row-start-2 col-span-8">
            
        </div>

        <!-- Row 2, Column 10: Address -->
