...
<nav class="bg-white py-4 px-8 flex flex-wrap justify-between items-center">
  ...
  <ul class="flex w-1/3 justify-center space-x-6 font-montserrat font-medium">
    <li><a href="{{ route('home') }}" class="{{ Route::currentRouteName() === 'home' ? 'active-link' : '' }}">Home</a></li>
    <li><a href="{{ route('about') }}" class="{{ Route::currentRouteName() === 'about' ? 'active-link' : '' }}">About us</a></li>
    <li><a href="{{ route('portfolio') }}" class="{{ Route::currentRouteName() === 'portfolio' ? 'active-link' : '' }}">Portfolio</a></li>
    <li><a href="{{ route('equipment') }}" class="{{ Route::currentRouteName() === 'equipment' ? 'active-link' : '' }}">Equipment</a></li>
</ul>
